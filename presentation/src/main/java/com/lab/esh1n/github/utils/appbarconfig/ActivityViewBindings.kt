package com.lab.esh1n.github.utils.appbarconfig
...
class ActivityAppBarConfigProperty<A : ComponentActivity, T : Any>(appBarProvider: (A) -> T) : ViewBindingProperty<A, T>(appBarProvider) {
